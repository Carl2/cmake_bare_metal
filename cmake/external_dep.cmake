...
function(f4_HAL_support)
  ...
  cmake_parse_arguments(DEVICE "" "DESTINATION;CONF_DIR" "" ${ARGN} )
  ...
  # ExternalProject_Add(stm32F4_HAL_support
  #   GIT_REPOSITORY    git@github.com:STMicroelectronics/STM32CubeF4.git
  #   GIT_TAG           v1.7.13
  #   SOURCE_DIR ${HAL_DIR}
  #   GIT_SHALLOW       True
  ...
  #set(STM_DEVICE_SUPPORT_INCLUDE "${}/Include" PARENT_SCOPE )



  # f4_device_support(${DEVICE_DESTINATION}/cmsis_device_f4)
  # Lets create a library of the whole thing.
  set(LIB_NAME "f4_hal_library" PARENT_SCOPE)
 ...
 message(STATUS "Creating target stm32F4_mcu_support")
...
#   ExternalProject_Add(stm32F4_cmsis_support
#     GIT_REPOSITORY    git@github.com:STMicroelectronics/cmsis_device_f4.git
#     GIT_TAG           v1.7.13
#     SOURCE_DIR ${CMAKE_SOURCE_DIR}/external/cmsis_hal_f4
#     CONFIGURE_COMMAND ""
#     BUILD_COMMAND ""
#     INSTALL_COMMAND ""
#     )
...
# endfunction(add_cmsis_external)
